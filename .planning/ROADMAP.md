...
- [ ] 01-03-PLAN.md — Doc-only gripper-name correction (Robotiq Hand-E) across .planning/, CLAUDE.md, exts/aic-dt/docs/README.md, exts/aic-dt/docs/CHANGELOG.md (D-03)
- [ ] 01-04-PLAN.md — extension.py renames (33 _sim/_real cells) + gripper-name correction (Robotiq Hand-E) + prim-path bug fix + AIC_OBJECTS update + delete setup_pose_publisher / sync_real_poses atoms (DX-02 deletion-side) + PARITY-05 wrench full match
