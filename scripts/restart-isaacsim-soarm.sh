...
#
# Usage:
#   ./scripts/restart-isaacsim-soarm.sh             # kill + touch + hardened launch
...
#   ./scripts/restart-isaacsim-soarm.sh --reset-user # ignore Kit user.config for a clean launch
#   ./scripts/restart-isaacsim-soarm.sh --capture-on-play # opt back into Replicator captureOnPlay
#   ./scripts/restart-isaacsim-soarm.sh --service   # launch under a transient systemd --user unit
#
# Exit codes:
